...
for day_number in range(5):
    if day_number == 0: day = "Monday"
    elif day_number == 1: day = "Tuesday"
    elif day_number == 2: day = "Wednesday"
    elif day_number == 3: day = "Thursday"
    else: day = "Friday"
    received = int(input(f"{day} received: "))
    resolved = int(input(f"{day} resolved: "))
    if received < 0 or resolved < 0 or resolved > received: invalid = True
