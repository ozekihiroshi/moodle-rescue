...
[公開体験版](../ap-written-practice-ja-preview/README.md)は、この完全版の正本から案内、問1、問2だけを収録した別コースです。コース名に「公開体験版（問1・問2）」と明記し、LessonMarkとMarkdown教材制作の広報・試用を目的にゲスト公開できます。完全版は全11問を保持し、ログイン・受講登録を必要とするコースとして運用します。
